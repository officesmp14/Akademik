...
export default function StatistikSekolahPage() {
  ...
  return (
    <div className="p-6 md:p-8 print:p-0">
      ...
      <h1 className="text-2xl font-semibold text-slate-900 mb-1">Statistik Rombel & Agama</h1>
      ...
      {loading ? (
        ...
        <>
          <p className="text-sm font-semibold text-slate-800 mb-3">Jumlah Rombel per Jenjang</p>
          ...
          <p className="text-sm font-semibold text-slate-800 mb-3">Jumlah Siswa Berdasarkan Agama</p>
