  ...
  return (
    <div className="p-6 md:p-8 dark:bg-slate-900">
      ...
      <p className="text-sm text-slate-500 dark:text-slate-400 mb-6">
        ...
        Pendidikan — data personal masuk ke <code className="bg-slate-100 dark:bg-slate-700 px-1 py-0.5 rounded text-xs">datagtk</code>,
        data penugasan mengajar (mapel/sekolah) otomatis masuk ke{" "}
        <code className="bg-slate-100 dark:bg-slate-700 px-1 py-0.5 rounded text-xs">gtk_penugasan_mengajar</code>.
      </p>
