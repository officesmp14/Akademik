...
export default function TandaTerimaStsPage() {
  ...
  const loadData = useCallback(async () => {
    ...
    const [profilRes, waliKelasInfoResult, siswaRes, panitiaRes] = await Promise.all([
  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto print:p-0 print:max-w-none">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-5 print:hidden">
        <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100">Tanda Terima STS</h1>
        <button
          onClick={handlePrint}
