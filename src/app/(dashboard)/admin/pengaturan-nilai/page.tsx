...
export default function PengaturanNilaiPage() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-slate-900">Pengaturan Nilai</h1>
      ...
      <form
        onSubmit={saveBobot}
        className="bg-white border border-slate-200 rounded-xl overflow-hidden mb-8"
      >
        ...
        <div className="p-5 space-y-3">
          <div className="flex items-center justify-between gap-4">
            <label className="text-sm text-slate-700">Nilai Formatif (F)</label>
            <input
              type="number"
              ...
              className="w-24 rounded-lg border border-slate-300 px-3 py-1.5 text-sm text-center focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
          <div className="flex items-center justify-between gap-4">
            <label className="text-sm text-slate-700">Nilai Sumatif Lingkup Materi (S)</label>
            <input
              type="number"
          ...
          <div className="flex items-center justify-between gap-4">
            <label className="text-sm text-slate-700">Nilai Sumatif Akhir Semester (SA)</label>
            <input
              type="number"
      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
        <div className="px-4 py-3 border-b border-slate-200 flex items-center justify-between">
          <p className="text-sm font-semibold text-slate-800">KKB per Mata Pelajaran</p>
          {selected.size > 0 && (
            <button
              onClick={handleDeleteSelected}
              className="inline-flex items-center gap-1.5 text-xs font-medium text-red-600 hover:bg-red-50 px-2 py-1 rounded-lg"
            >
                  ...
                  <td className="px-4 py-2">
                    <div className="flex items-center justify-center gap-1.5">
                      <input
                        ...
                        placeholder="-"
                        className="w-20 rounded-lg border border-slate-300 px-2 py-1.5 text-sm text-center focus:outline-none focus:ring-2 focus:ring-indigo-500"
                      />
                      {savingMapelId === p.id && (
