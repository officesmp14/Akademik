          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading ? (
                ...
                filteredUsers.slice(page * pageSize, page * pageSize + pageSize).map((u, idx) => (
                  <tr key={u.id} className="border-b border-slate-100 last:border-0 hover:bg-slate-50/60">
                    ...
                    <td className="px-4 py-3 text-slate-600">{u.gtk_nama || "-"}</td>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm disabled:bg-slate-50 disabled:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              </div>
      ...
      {deleteTarget && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl p-6 max-w-sm w-full shadow-xl">
            <h3 className="font-semibold text-slate-900 mb-1.5">Hapus user ini?</h3>
            <p className="text-sm text-slate-500 mb-5">
              Akun <span className="font-medium text-slate-700">{deleteTarget.email}</span> akan
