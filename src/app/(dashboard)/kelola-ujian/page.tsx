  ...
  return (
    <div className="p-6 md:p-8">
      <div className="mb-6 flex items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-slate-900">Kelola Ujian</h1>
          <p className="text-sm text-slate-500 mt-1">Buat ujian, bank soal, dan sesi ujian online siswa</p>
        </div>
        <button
          onClick={openAdd}
            ...
            {loading ? (
              ...
              list.map((u) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-slate-700">{u.mapel || "-"}</td>
                  <td className="px-4 py-3 text-slate-700">{u.durasi_menit} menit</td>
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl p-6 max-w-sm w-full shadow-xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-slate-900">Buat Ujian Baru</h3>
